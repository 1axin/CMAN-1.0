...
def parameter_parser():
    ...
    parser.add_argument("--graph-input",
                        nargs="?",
                        default="E:\\001_写作过程\\2022_12_10论文写作_有思路\\0_实验完美版\\03_Role2vec\\role2vec-master\\input\\CMCI网络.csv",
	                help="Input graph path -- edge list csv.")

    parser.add_argument("--output",
                        nargs="?",
                        default="E:\\001_写作过程\\2022_12_10论文写作_有思路\\0_实验完美版\\03_Role2vec\\role2vec-master\\output\\role-vec.csv",
