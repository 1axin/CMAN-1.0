...
OUTPUT_DIR = 'E:\\001_写作过程\\2022_12_10论文写作_有思路\\2_实验完整版\\05_SiGAT\\03_sigat\\embeddings_64'
if not os.path.exists('embeddings_64'):
    os.mkdir('embeddings_64')
...
def run( dataset='bitcoin_alpha', k=2):
    ...
    filename = './experiment-data/bitcoin_alpha-train-3.csv'.format(dataset, k)
